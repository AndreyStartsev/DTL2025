...
- Отслеживание использования агрегаций и соединений
...
│   ├── query_analyzer.py       # Анализ SQL-запросов
│   ├── db_stats_collector.py   # Сбор статистик БД
...
OLLAMA_HOST=your_ollama_host   # например, http://localhost
OLLAMA_PORT=11434
...
|------------------|-------------|---------|
| `OPENROUTER_API_KEY` | API ключ для LLM сервиса | Обязательно |
| `OLLAMA_HOST`     | Хост сервиса OLLAMA | `http://localhost` |
| `OLLAMA_PORT`    | Порт сервиса OLLAMA | `11434` |
| `OLLAMA_MODEL`   | Модель LLM для использования | `llama3.1:8b` |
